...
import { generateId, getResumeItems, type Education, type Internship, type Project, type Certification, DEFAULT_SECTION_ORDER, DEFAULT_FORMATTING, type ResumeSectionId, type ResumeFormatting } from "@/lib/portfolioData";
